...
**主要更新内容**：
1. ✅ 在"2.4 导航栏设计规范"中更新了布局：Logo 居左、Nav Items 绝对居中、多语言切换居右
2. ✅ 在"附录 A.5 导航栏组件"中添加了完整 HTML/CSS/JS 代码，支持悬浮触发语言菜单
3. ✅ 在"附录 E.3 语言切换器组件规范"中更新了交互逻辑：**鼠标悬浮触发悬浮菜单**（非点击下拉），双列网格布局
4. ✅ 更新了版本历史（v1.2）

**关键变更**：
- 🎯 导航栏三栏布局：Logo 左、Nav 绝对居中、语言右
- 🖱️ 语言切换器：**悬浮触发**悬浮菜单（非点击下拉），0.3s 淡入动画
- 🌐 双列网格菜单：最多 14 种语言，当前语言显示 ✓ 标记
- 📱 移动端适配：点击触发，单列布局
