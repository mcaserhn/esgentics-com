...
export default function Technology() {
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container-content">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-title font-bold mb-6">{translations?.technology?.hardware_layer?.title || 'Hardware Layer: NVIDIA-Powered Edge Intelligence'}</h2>
              ...
              <div className="space-y-4">
                {
                  (translations?.technology?.hardware_layer?.features || []).map((item, index) => (
                    <div key={index} className="flex items-start">
                      <div className="mt-1 mr-4 text-aden-orange">
            ...
            >
              ...
              <div className="w-full h-80 md:h-80 bg-gray-100 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-aden-dark-gray font-body">NVIDIA Edge Computing</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="w-full h-80 bg-gray-800 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 font-body">Unified Real Estate Data OS</p>
                </div>
              </div>
            </motion.div>
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-title font-bold mb-6">{translations?.technology?.platform_layer?.title || 'Platform Layer: Unified Real Estate Data OS'}</h2>
              <p className="text-lg text-gray-200 mb-8 font-body">
              ...
              <div className="space-y-4">
                {
                  (translations?.technology?.platform_layer?.features || []).map((item, index) => (
                    <div key={index} className="flex items-start">
                      ...
                      <p className="text-gray-200 font-body">{item}</p>
                    </div>
                  ))
                }
              </div>
        ...
        <div className="container-content">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-title font-bold mb-6">{translations?.technology?.spatial_intelligence_layer?.title || 'Spatial Intelligence Layer: Built on OpenUSD + NVIDIA Omniverse'}</h2>
              <p className="text-lg text-aden-dark-gray mb-8 font-body">
            ...
            >
              ...
              <div className="w-full h-80 bg-gray-100 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-aden-dark-gray font-body">Spatial Intelligence</p>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              <div className="w-full h-80 bg-gray-800 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 font-body">AI Engine</p>
                </div>
              </div>
            </motion.div>
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-title font-bold mb-6">{translations?.technology?.ai_engine?.title || 'AI Engine: Proprietary Algorithms for Autonomous Action'}</h2>
              <p className="text-lg text-gray-200 mb-8 font-body">
      ...
      <section className="py-16 bg-aden-light-gray">
          ...
          >
            <div className="inline-block bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center justify-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-title font-bold text-aden-dark-blue">{translations?.technology?.nvidia_partner?.title || 'NVIDIA Partner'}</h3>
                  <p className="text-aden-dark-gray font-body">{translations?.technology?.nvidia_partner?.subtitle || 'Powered by NVIDIA technology'}</p>
                </div>
              </div>
            </div>
          </motion.div>
