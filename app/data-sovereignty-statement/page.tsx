    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.introduction?.title || 'Introduction'}</h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.data_residency?.title || 'Data Residency'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.compliance?.title || 'Compliance with Regional Laws'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.data_transfer?.title || 'Data Transfer'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.data_security?.title || 'Data Security'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.user_rights?.title || 'Your Rights'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.data_sovereignty_statement?.sections?.contact?.title || 'Contact Us'}</h2>
              <p className="text-dark-gray mb-4">
