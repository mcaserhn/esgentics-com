    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.introduction?.title || 'Introduction'}</h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.use_of_website?.title || 'Use of the Website'}</h2>
              <p className="text-dark-gray mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-dark-gray">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.intellectual_property?.title || 'Intellectual Property'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.services?.title || 'Services'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.limitation_of_liability?.title || 'Limitation of Liability'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.disclaimer_of_warranties?.title || 'Disclaimer of Warranties'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.indemnification?.title || 'Indemnification'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.governing_law?.title || 'Governing Law'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.changes?.title || 'Changes to These Terms'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.terms_of_service?.sections?.contact?.title || 'Contact Us'}</h2>
              <p className="text-dark-gray mb-4">
