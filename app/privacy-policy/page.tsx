    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.introduction?.title || 'Introduction'}</h2>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.data_collected?.title || 'Data We Collect'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.data_usage?.title || 'How We Use Your Data'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.data_sharing?.title || 'Data Sharing'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.data_security?.title || 'Data Security'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.data_residency?.title || 'Data Residency'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.user_rights?.title || 'Your Rights'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.cookies?.title || 'Cookies'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.changes?.title || 'Changes to This Policy'}</h2>
              <p className="text-dark-gray mb-4">
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold mb-4">{translations?.privacy_policy?.sections?.contact?.title || 'Contact Us'}</h2>
              <p className="text-dark-gray mb-4">
